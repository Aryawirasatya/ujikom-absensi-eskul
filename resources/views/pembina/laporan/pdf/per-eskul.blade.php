{{-- =====================================================
     FILE: resources/views/admin/laporan/pdf/per-eskul.blade.php
===================================================== --}}
<!DOCTYPE html>
<html lang="id">
<head>
...
.header{background:#1E3A5F;color:#fff;padding:14px 20px;margin-bottom:16px;}
.header h1{font-size:14px;font-weight:bold;}
.header .sub{font-size:8px;opacity:.75;margin-top:3px;}
.kpi-row{display:flex;gap:8px;margin:0 20px 16px;flex-wrap:wrap;}
.kpi-box{flex:1;min-width:90px;background:#F8FAFC;border:1px solid #E2E8F0;border-radius:6px;padding:8px;text-align:center;}
...
.section-title{font-size:10px;font-weight:bold;color:#1E3A5F;border-bottom:2px solid #1E3A5F;padding-bottom:3px;margin:0 20px 8px;}
table{width:calc(100% - 40px);margin:0 20px 16px;border-collapse:collapse;}
th{background:#1E3A5F;color:#fff;padding:5px 6px;font-size:8px;text-align:left;}
...
<div class="kpi-row">
    <div class="kpi-box"><div class="v">{{ $stats['totalKegiatan'] }}</div><div class="l">Total Kegiatan</div></div>
    <div class="kpi-box green"><div class="v">{{ $stats['pctKeseluruhan'] }}%</div><div class="l">Rate Hadir</div></div>
    <div class="kpi-box"><div class="v">{{ collect($studentSummary)->count() }}</div><div class="l">Anggota</div></div>
    <div class="kpi-box red"><div class="v">{{ collect($activitySummary)->sum('alpha') }}</div><div class="l">Total Alpha</div></div>
    <div class="kpi-box amber"><div class="v">{{ collect($activitySummary)->sum('telat') }}</div><div class="l">Total Telat</div></div>
</div>
...
<table>
    <thead>
        <tr>
            ...
            <th style="text-align:center;width:40px">% Hadir</th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align:center"><span class="badge bg-blue">{{ $act['izin'] }}</span></td>
