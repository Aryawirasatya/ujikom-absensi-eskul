{{-- resources/views/pembina/penilaian/show-siswa.blade.php --}}
@extends('layouts.app')
...
.hdr-btn.accent { border-color:#fde68a; background:#fffbeb; color:#92400e; }
.hdr-btn.accent:hover { background:#fef3c7; }
...
<div class="ps-wrap">
    ...
    <div class="ps-crumb">
        ...
        <span class="ps-crumb-sep">›</span>
        <a href="{{ route('pembina.penilaian.laporan', $eskul) }}">Laporan</a>
        <span class="ps-crumb-sep">›</span>
    ...
    <div class="student-card">
        <div class="d-flex align-items-center gap-3 flex-wrap">
            @if($user->photo)
                <img src="{{ asset('storage/students/'.$user->photo) }}" class="stu-av-img">
            @else
            ...
            <div class="flex-grow-1">
                ...
                <div class="stu-sub">
                    {{ $eskul->name }}
                    @if($user->nisn) &nbsp;&middot;&nbsp; NISN: {{ $user->nisn }} @endif
                </div>
            ...
            <div class="d-flex gap-2 flex-shrink-0">
                <a href="{{ route('pembina.penilaian.index', $eskul) }}" class="hdr-btn accent">
                    <i class="bi bi-star-fill" style="color:var(--amber)"></i> Nilai
                </a>
...
{{-- ═══ SCRIPT radar — satu @push, tidak ada @endsection ganda ═══ --}}
@push('scripts')
@if(count($radarData['labels']) >= 3)
